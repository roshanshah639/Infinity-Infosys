...
const FiPhoneCall = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M20 15.5c-1.25 0-2.5-.3-3.7-.8c-.8-.3-1.7-.2-2.3.4l-1.3 1.3c-2.7-1.4-4.8-3.5-6.2-6.2l1.3-1.3c.6-.6.7-1.5.4-2.3c-.5-1.2-.8-2.5-.8-3.7c0-1.1-.9-2-2-2H4C2.9 2 2 2.9 2 4c0 9.4 7.6 17 17 17c1.1 0 2-.9 2-2v-2c0-1.1-.9-2-2-2z" />
  </svg>
);
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8">
          ...
          <div className="flex flex-col gap-4 md:hidden">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* Contact Us Card (now matching location) */}
              <div className="bg-white p-5 rounded-lg shadow-lg transition-all duration-500 ease-out">
                <div className="flex items-center text-center gap-2">
                  <div className="rounded-full border-[1.2px] border-dashed border-[#FFBC13] p-2 mb-2">
                    <FiPhoneCall />
                  ...
                  <div className="flex flex-col items-start justify-center">
                    ...
                    <p className="text-sm text-gray-600">
                      <a
                        href="https://wa.me/9779802984222"
                        className="text-gray-600 hover:text-[#FFBC13] transition-colors pl-2.5"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 w-full">
            ...
            <div className="w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[450px] rounded-lg overflow-hidden shadow-lg hidden md:block">
              <iframe
